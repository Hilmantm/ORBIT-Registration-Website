...
<head>
  ...
  <!-- Icon -->
  <link rel="icon" href="<?php echo e(asset('ORBITLogo.png')); ?>">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="<?php echo e(asset('fonts/font-awesome-5.0/css/fontawesome-all.min.css')); ?>">
  ...
  <link rel="stylesheet" href="<?php echo e(asset('dist/css/tambahan.css')); ?>">
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="<?php echo e(route('Dashboard')); ?>" class="brand-link" style="text-align: center;">
      <img src="<?php echo e(asset('ORBITHorizontalLogo.png')); ?>" alt="ORBIT Logo" width="80%">
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview <?php echo $__env->yieldContent('menu-open'); ?>">
            <a href="#" class="nav-link <?php echo $__env->yieldContent('menu-active'); ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(route('Data Pendaftar')); ?>" class="nav-link <?php echo $__env->yieldContent('menu-active'); ?>">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <?php echo $__env->yieldContent('routeNavigation'); ?>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?= Date('Y') ?> <a href="http://adminlte.io">ORBIT</a>.</strong> All rights
    reserved.
  </footer>
