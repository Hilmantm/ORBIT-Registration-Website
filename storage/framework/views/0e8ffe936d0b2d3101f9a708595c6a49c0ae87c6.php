...
<div class="wrapper">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(route('dataPendaftar')); ?>" class="nav-link<?php echo e(set_active('dataPendaftar', ' active')); ?>">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Data Pendaftar</p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item<?php echo e(set_active('dataPendaftar', ' active')); ?>">Data Tables</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo e(date('Y')); ?> <a href="http://adminlte.io">ORBIT</a>.</strong> All rights
    reserved.
  </footer>
